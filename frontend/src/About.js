        ...
        <Card bg="light">
          ...
          <Card.Title className="text-center" style={{ fontSize: '1.4rem', color: 'black'}}>What is Spaced Repetition?</Card.Title>
            <Card.Text className="text-center" style={{ fontSize: '1.2rem', color: 'black' }}>
                ...
                they have learned and will avoid the Forgetting Curve phenomenon. This will ultimately lead to improved performance 
            ...
            <Card.Title className="text-center" style={{ fontSize: '1.4rem', color: 'black'}}>How does CodeNext utilize Spaced Repetition?</Card.Title>
            <Card.Text className="text-center" style={{ fontSize: '1.2rem', color: 'black' }}>
