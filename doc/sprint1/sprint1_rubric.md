...
Your Mark: 2 (note that commit messages should be in present tense)
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  - Cover Page and Table of Contents (max 2 marks)
    ...
    Your Mark: 2 (uh, i think the page numbers on your table of contents is a little off LOL. great job on the rest of it though)
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 2 (did not provide a referenced for 3 tiered architecture)
...
## Sprint Demo (Max 14 marks) 
  ...
  - Presentation (max 2 marks)
    ...
    - 0 marks = UI is visually unappealing
        ...
        Definitely look into a cohesive colour scheme, as well as some better margins for the buttons/cards

        For the registrations/login page, get rid of the transparency

        Add boxes/backgrounds to the headers, and replace the background gradient
